...
*************************************************
      ...
      real(8), parameter :: deltar=0.2             ! lattice spacing
      real(8), parameter :: l=1                    ! magnetic quantum number 
cc
...
cc 
      write(filename,'(a7,f6.2,a6,I4,a4)') 
     &          'deltar=',deltar,',Ncut=',Ncut,'.dat'
      open(10,file=filename)  
cc 
      do 100 xB=0,65.01,0.5                         ! magnetic field         
      write(*,*) xB  
      Amat=0
