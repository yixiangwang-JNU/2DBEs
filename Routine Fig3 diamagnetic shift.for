...
**********************
      ...
      write(filename,'(a13)') 'rsquare.dat'       
...
cc
      ...
      do i=1,Ncut
         ri=(i-1)*deltar 
         rsquare(1)=rsquare(1)+deltar*ri*ri*probN1(i)*0.000109907
         rsquare(2)=rsquare(2)+deltar*ri*ri*probN2(i)*0.000109907    
         rsquare(3)=rsquare(3)+deltar*ri*ri*probN3(i)*0.000109907    
         rsquare(4)=rsquare(4)+deltar*ri*ri*probN4(i)*0.000109907     
      end do
      write(10,'(I2,100f16.8)') l, (rsquare(i),i=1,4) 
cc 
100   continue 
cc 
      end program main     
