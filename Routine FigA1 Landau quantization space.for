*********************************************
*     Calculate the exciton energy levels 
*********************************************
      module value
...
cc      
      ...
      real(8), parameter :: xB=5                     ! magnetic field
      real(8), parameter :: xlB=25.6/sqrt(xB)        ! magnetic length
      real(8), parameter :: omegae=0.11578*xB/xme
      real(8), parameter :: omegah=0.11578*xB/xmh      
      character(1), parameter :: JOBZ='N'
      character(1), parameter :: UPLO='U'  
cc
      common nmin,nmax,nabs    
cc
      end module value
cc      
**********************
...
**********************
      ...
      implicit double precision (a-h,o-z)
      real(8), allocatable :: H(:,:),EVAL(:),WORK(:) 
      external V1
      character(100) filename
      write(filename,'(a2,I2,a5,f4.1,a4)') 'l=',l,', xB=',xB,'.dat' 
      open(10,file=filename)
cc 
      do 100 Ncut=100,351,10
      write(*,*) Ncut     
      Ndim=Ncut                ! dimension
      LDA=Ndim
      LWORK=3*Ndim      
...
cc       
      ...
      write(10,'(I4,100f16.8)') Ncut,(EVAL(i),i=1,5) 
cc      
      deallocate(H)
      deallocate(EVAL)
      deallocate(WORK) 
